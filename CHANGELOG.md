...
- Merge develop into trunk ([#62](https://github.com/acicovic/keep-a-changelog-test/pull/62))

## 1.0.13 - 2022-05-10

- Update released.yml ([#61](https://github.com/acicovic/keep-a-changelog-test/pull/61))
- Update hello.php ([#60](https://github.com/acicovic/keep-a-changelog-test/pull/60))
- Merge develop into trunk ([#59](https://github.com/acicovic/keep-a-changelog-test/pull/59))

## 1.0.12 - 2022-05-10

- Merge develop into trunk ([#58](https://github.com/acicovic/keep-a-changelog-test/pull/58))

## 1.0.11 - 2022-05-09

- Merge develop into trunk ([#57](https://github.com/acicovic/keep-a-changelog-test/pull/57))

## 1.0.10 - 2022-05-09

- Merge develop into trunk ([#56](https://github.com/acicovic/keep-a-changelog-test/pull/56))

## 1.0.9 - 2022-05-09

- Merge develop into trunk ([#55](https://github.com/acicovic/keep-a-changelog-test/pull/55))

## 1.0.8 - 2022-05-09

- Update prereleased.yml ([#54](https://github.com/acicovic/keep-a-changelog-test/pull/54))
...
- *Open on Parse.ly* links are displayed by default. [#433](https://github.com/Parsely/wp-parsely/pull/433)
