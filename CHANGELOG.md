...
- Merge develop into trunk ([#64](https://github.com/acicovic/keep-a-changelog-test/pull/64))

## 1.0.15 - 2022-05-10

- Merge develop into trunk ([#63](https://github.com/acicovic/keep-a-changelog-test/pull/63))
